...
func _include_system(p_header_name: String, _p_includer_name: String, p_inclusion_depth: int, _p_user_data: RefCounted) -> gdglslangIncludeResult:
	var full_path: String = _get_include_full_path_if_valid(p_header_name, p_inclusion_depth)
	if FileAccess.file_exists(full_path):
		...
		return gdglslangIncludeResult.create_new(p_header_name, file.get_as_text(), null)

	return null

func _include_local(_p_header_name: String, _p_includer_name: String, _p_inclusion_depth: int, _p_user_data: RefCounted) -> gdglslangIncludeResult:
	return null

func _pre_release_include(_p_result: gdglslangIncludeResult, _p_user_data: RefCounted) -> void:
	return
